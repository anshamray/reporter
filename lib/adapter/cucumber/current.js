...
class CucumberReporter extends Formatter {
  ...
  onTestCaseFinished(testCaseFinished) {
    ...
    console.log('testCaseAttempt', testCaseAttempt);
    console.log('retry number', testCaseAttempt.attempt);
    ...
    this.client.addTestRun(status, {
      ...
      test_id: testId,
      time,
      retry: testCaseAttempt.attempt,
      willBeRetried: testCaseAttempt.attempt,
    });
